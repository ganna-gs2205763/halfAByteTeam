...
class _GenerateProgressAssessmentScreenState
  ...
  Widget _selectQuestionCountDialog(BuildContext context) {
    ...
    return AlertDialog(
      title: const Text("Please select the number of questions per topic."),
  ...
  Future<void> generateExamInParts(
    ...
    try {
      for (var topic in topicsSelected) {
        String prompt =
            "Generate $numOfQuestions multiple-choice questions for the topic "
            "'$topic' for students in grade ${int.parse(grade) - 1}. "
